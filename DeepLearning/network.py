...
class UNet(nn.Module):
    def __init__(self, n_channels=3, n_classes=1, bilinear=True, sigmoid=False):
        ...
        self.down1 = Down(64, 128, kernel_size=3, padding=1)
        self.down2 = Down(128, 256, kernel_size=3, padding=1)
        self.down3 = Down(256, 512, kernel_size=3, padding=1)
        self.down4 = Down(512, 512, kernel_size=3, padding=1)
