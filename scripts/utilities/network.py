...
def double_conv2d_dropout(inputs, nb_out_channels, activation_f = 'relu', padding = 'same', dilation_rate = (1,1), \
							kernel_initializer = 'glorot_uniform', dropout_rate = 0.2):
	"""
	Performs 2 convolutions and a droput in between
	"""
	conv1 = Conv2D(nb_out_channels, 3, activation = activation_f, padding = padding, dilation_rate = dilation_rate, \
...
def up(inputs, conv_to_merge, nb_out_channels, activation_f = 'relu', padding = 'same', dilation_rate = (1,1), \
		...
		"""
		up1 = Conv2D(nb_out_channels, 3, activation = activation_f, padding = padding, kernel_initializer = kernel_initializer) \
...
def unet_5_layers(input_size = (128,128,3), nb_out_channels = 16,  activation_f = 'relu', dilation_rate = (1,1), padding = 'same', \
    ...
    conv1 = double_conv2d_dropout(inputs, nb_out_channels, kernel_size = 3, activation_f = activation_f, padding = padding, \
						dilation_rate = dilation_rate, kernel_initializer = kernel_init)
    pool1 = MaxPooling2D(pool_size=(2, 2))(conv1)

    conv2 = double_conv2d_dropout(pool1, nb_out_channels*2, kernel_size = 3, activation_f = activation_f, padding = padding, \
						dilation_rate = dilation_rate, kernel_initializer = kernel_init)
    pool2 = MaxPooling2D(pool_size=(2, 2))(conv2)

    conv3 = double_conv2d_dropout(pool2, nb_out_channels*4, kernel_size = 3, activation_f = activation_f, padding = padding, \
						dilation_rate = dilation_rate, kernel_initializer = kernel_init)
    pool3 = MaxPooling2D(pool_size=(2, 2))(conv3)

    conv4 = double_conv2d_dropout(pool3, nb_out_channels*8, kernel_size = 3, activation_f = activation_f, padding = padding, \
						dilation_rate = dilation_rate, kernel_initializer = kernel_init)
    pool4 = MaxPooling2D(pool_size=(2, 2))(conv4)
    
    conv5 = double_conv2d_dropout(pool3, nb_out_channels*16, kernel_size = 3, activation_f = activation_f, padding = padding, \
						dilation_rate = dilation_rate, kernel_initializer = kernel_init)
    ...
    up7 = up(up6, conv4, nb_out_channels*8, kernel_size = kernel_init, activation_f = activation_f, padding = padding, \
						dilation_rate = dilation_rate, kernel_initializer = kernel_init)				
		
    up8 = up(up7, conv3, nb_out_channels*4, kernel_size = kernel_init, activation_f = activation_f, padding = padding, \
						dilation_rate = dilation_rate, kernel_initializer = kernel_init)
							
    up9 = up(up8, conv2, nb_out_channels*2, kernel_size = kernel_init, activation_f = activation_f, padding = padding, \
						dilation_rate = dilation_rate, kernel_initializer = kernel_init)	
							
    up10 = up(up9, conv1, nb_out_channels*2, kernel_size = kernel_init, activation_f = activation_f, padding = padding, \
						dilation_rate = dilation_rate, kernel_initializer = kernel_init)	
...
def unet_4_layers(input_size = (128,128,3), nb_out_channels = 32,  activation_f = 'relu', dilation_rate = (1,1), padding = 'same', \
					kernel_init = 'glorot_uniform', verbose = 0):
    """Creates our implementation of UNet compiled with the following parameters:
        optimiser: Adam with default parameters
        loss: binary crossentropy
    ...
    conv6 = Conv2D(nb_out_channels*16, 3, activation = activation_f, padding = padding, kernel_initializer = kernel_init)(pool4)
    conv6 = Conv2D(nb_out_channels*16, 3, activation = activation_f, padding = padding, kernel_initializer = kernel_init)(conv6)
